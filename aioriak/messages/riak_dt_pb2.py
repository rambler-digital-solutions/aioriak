...
GSetOp = _reflection.GeneratedProtocolMessageType('GSetOp', (_message.Message,), dict(
  DESCRIPTOR = _GSETOP,
  __module__ = 'riak_dt_pb2'
  # @@protoc_insertion_point(class_scope:GSetOp)
  ))
_sym_db.RegisterMessage(GSetOp)

HllOp = _reflection.GeneratedProtocolMessageType('HllOp', (_message.Message,), dict(
  DESCRIPTOR = _HLLOP,
  __module__ = 'riak_dt_pb2'
  # @@protoc_insertion_point(class_scope:HllOp)
  ))
_sym_db.RegisterMessage(HllOp)
