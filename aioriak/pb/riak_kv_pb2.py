...
import aioriak.pb.riak_pb2 as riak__pb2
...
_RPBCONTENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ttl', full_name='RpbContent.ttl', index=11,
      number=12, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RPBINDEXRESP.fields_by_name['results'].message_type = riak__pb2._RPBPAIR
...
_RPBCONTENT.fields_by_name['usermeta'].message_type = riak__pb2._RPBPAIR
_RPBCONTENT.fields_by_name['indexes'].message_type = riak__pb2._RPBPAIR
