.. _datatypes:
.. currentmodule:: aioriak.datatypes
...
Here is the list of current Data Types:
    ...
    * :py:class:`~aioriak.datatypes.Counter` increments or decrements
      integer values
    * :py:class:`~aioriak.datatypes.Set` allows you to store multiple
      distinct opaque binary values against a key
    * :py:class:`~aioriak.datatypes.Map` is a nested, recursive
    ...
    * :py:class:`~aioriak.datatypes.Register` stores binaries
      accoring to last-write-wins logic within
      :py:class:`~aioriak.datatypes.Map`
    * :py:class:`~aioriak.datatypes.Flag` is similar to a boolean
      and also must be within :py:class:`~aioriak.datatypes.Map`

All Data Types must be stored in buckets bearing a
:class:`~aioriak.bucket.BucketType` that sets the
:attr:`~aioriak.bucket.BucketType.datatype` property to one of
...
:class:`~aioriak.riak_object.RiakObject` instances, using
:meth:`Bucket.get <aioriak.bucket.Bucket.get>` and
:meth:`Bucket.new <aioriak.bucket.Bucket.new>`, except that the
...
:class:`~aioriak.riak_object.RiakObject` instances, only mutations are
...
:ref:`vclock` on :class:`~aioriak.riak_object.RiakObject`. The Python
...
.. autocomethod:: Datatype.reload
.. autocomethod:: Datatype.update
.. cofunction:: Datatype.store(**params)

    This is an alias for :meth:`~aioriak.datatypes.Datatype.update`.

.. autocomethod:: Datatype.delete
...
:py:class:`Map <aioriak.datatypes.Map>` objects (in addition to
:py:class:`Map <aioriak.datatypes.Map>` itself):
